...
const angleDownIcon: JSX.Element = (
    <svg name="angle-down" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512">
    ...
    handleClick(context: TimerStepperContext, type: TimerStepperTypes, currentValue: TimepickerValue): TimepickerValue {
        ...
        switch (context) {
            case TimerStepperContext.Hours:
                ...
                switch (type) {
                    case TimerStepperTypes.Increment:
                        hours = hours === 12 ? 1 : hours + 1;
                        break;
                    case TimerStepperTypes.Decrement:
            ...
            case TimerStepperContext.Dayperiod:
                ...
                switch (dayperiod) {
                    case TimepickerDayperiodTypes.AM:
                        dayperiod = TimepickerDayperiodTypes.PM;
                        break;
                    case TimepickerDayperiodTypes.PM:
            ...
            <div className={"custom-timepicker" + (this.props.className ? ` ${this.props.className}` : "")} id={this.props.id}>
                <div className="timepicker-hours">
                    <div
                        ...
                        onClick={() => {
                            this.props.onChange(this.handleClick(TimerStepperContext.Hours, TimerStepperTypes.Increment, this.props.value));
                        }}
                    >
                        {angleUpIcon}
                    </div>
                    ...
                    <div
                        ...
                        onClick={() => {
                            this.props.onChange(this.handleClick(TimerStepperContext.Hours, TimerStepperTypes.Decrement, this.props.value));
                        }}
                    >
                        {angleDownIcon}
                    </div>
                ...
                <div className="timepicker-minutes">
                    <div
                        className="triangle-before"
                        onClick={() => {
                            this.props.onChange(this.handleClick(TimerStepperContext.Minutes, TimerStepperTypes.Increment, this.props.value));
                        }}
                    >
                        {angleUpIcon}
                    </div>
                    ...
                    <div
                        className="triangle-after"
                        onClick={() => {
                            this.props.onChange(this.handleClick(TimerStepperContext.Minutes, TimerStepperTypes.Decrement, this.props.value));
                        }}
                    >
                        {angleDownIcon}
                    </div>
                ...
                <div className="timepicker-dayperiod">
                    <div
                        className="triangle-before"
                        onClick={() => {
                            this.props.onChange(this.handleClick(TimerStepperContext.Dayperiod, TimerStepperTypes.Increment, this.props.value));
                        }}
                    >
                        {angleUpIcon}
                    </div>
                    <input type="text" name={this.props.name + "-dayperiod"} className="timepicker-input" readOnly={true} disabled={true} value={this.props.value.dayperiod} />
                    <div
                        className="triangle-after"
                        onClick={() => {
                            this.props.onChange(this.handleClick(TimerStepperContext.Dayperiod, TimerStepperTypes.Decrement, this.props.value));
                        }}
                    >
                        {angleDownIcon}
                    </div>
