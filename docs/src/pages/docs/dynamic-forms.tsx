...
const ShowMeEverything: React.FC = () => {
    ...
    const valueItems: DynamicFormItem[] = (["Text", "Datepicker", "Checkbox"] as DynamicFormItem["controlType"][]).map((controlType: DynamicFormItem["controlType"], i: number) => {
        let item: DynamicFormItem = {
            key: controlType,
    ...
    const [renderForm, state, , setErrors, meta, touched] = useDynamicForm(sections);
