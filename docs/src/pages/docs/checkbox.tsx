...
const CheckboxPage: React.FC = (): React.ReactElement<void> => {
    ...
    const importString: string = React.useMemo(() => require("!raw-loader!@sebgroup/react-components/CheckBox/CheckBox"), []);
    const importedFiles: Array<string> = React.useMemo(() => [require("!raw-loader!@sebgroup/react-components/CheckBox/CheckBox")], []);
