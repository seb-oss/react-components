        ...
        <div className="route-template container">
            <div className="info-holder">
                ...
                <div className="info">
                    ...
                    <div className="result wide">
                        <Accordion list={accordionList} iconRotation="deg-90" customIconExpanded={plusIcon} />
                    </div>

                    <p>Custom icon on the right</p>
                    <div className="result wide">
                        <Accordion list={accordionList} customIcon={angleDoubleRightIcon} iconPosition="right" iconRotation="deg-90" />
                    </div>

                    <p>Alternative theme</p>
                    <div className="result wide">
                        <Accordion list={accordionList} alternative={true} />
                    </div>
                </div>
            </div>
        </div>
