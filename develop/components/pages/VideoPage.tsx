            ...
            <div className="info-holder">
                ...
                <div className="info">
                    ...
                    <div className="result wide">
                        <Video name="myVideo" src={videoSrc} width="535px" height="300px" sourceType="local" autoplay={true} loop={true} />
                    </div>
                    <p>
                    ...
                    <div className="result wide">
                        <Video name="myVimeoVideo" src={vimeoSrc} width="535px" height="300px" sourceType="stream" />
                    </div>
                    <p>
                        Here are sample video streamed from{" "}
                        <em>
                    ...
                    <div className="result wide">
                        <Video name="myYoutubeVideo" src={youtubeSrc} width="535px" height="300px" sourceType="stream" showControls={true} />
                    </div>
                </div>
            </div>
        </div>
