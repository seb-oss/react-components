        ...
        <div className="route-template container">
            <div className="info-holder">
                ...
                <div className="info">
                    ...
                    <div className="result">
                        <Button title="Click me" label="Primary" onClick={() => null} theme="primary">
                            <Loader toggle={true} />
                        </Button>
                    </div>
                    ...
                    <div className="result">
                        <Button label="Test Label" iconPosition="left" icon={mysvg} onClick={() => null}>
                            <Loader toggle={true} />
                        </Button>
                    </div>
                    ...
                    <div className="result">
                        <Button label="Test Label" iconPosition="right" theme="secondary" icon={mysvg} onClick={() => null}>
                            <Loader toggle={true} />
                        </Button>
                    </div>
...
const SampleContainer: React.FC<SampleContainerProps> = (props: SampleContainerProps) => (
    <svg className="bd-placeholder-img img-thumbnail" width={props.width || "100%"} height={props.height} xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" role="img">
        <rect width="100%" height="100%" fill="#868e96" />
        <text x="50%" y="50%" fill="#dee2e6" textAnchor="middle">
            {props.text}
        </text>
    </svg>
);
